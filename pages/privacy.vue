<template>
  <v-container fluid tag="div">
    <div>
      <p class="text-h4">{{ $t("privacyPolicy") }}</p>
      <p>
        The LiveStreamNorge app is a Free app. This SERVICE is provided at no
      ...
      <p class="text-h5"><strong>Cookies</strong></p>
      <p>
      ...
      <p class="text-h5"><strong>Service Providers</strong></p>
      <p>
      ...
      <p class="text-h5"><strong>Security</strong></p>
      <p>
      ...
      <p class="text-h5"><strong>Links to Other Sites</strong></p>
      <p>
      ...
      <p class="text-h5"><strong>Changes to This Privacy Policy</strong></p>
      <p>
      ...
      <p class="text-h5"><strong>Contact Us</strong></p>
      <p>
